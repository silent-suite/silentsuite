...
if [[ -n "$navigation_mode" ]]; then
  case "$navigation_mode" in
    2) adb shell cmd overlay enable com.android.internal.systemui.navbar.gestural ;;
    0) adb shell cmd overlay enable com.android.internal.systemui.navbar.threebutton ;;
