...
class LoginLifecycleContractTest {
    ...
    fun accountRecreationRuntimeJobUsesTheRequiredUnsignedMatrixAndPinnedRunner() {
        ...
        listOf(
            "app:connectedDebugAndroidTest", "focused-runtime-ledger-v1.json", "len(tests) != 94",
    ...
    fun freshEmulatorShardsAreBoundedDisjointAndExactlyCoverRuntimeMethods() {
        ...
        assertTrue(runtimeScript.contains("if len(tests) != 94 or len(set(tests)) != 94"))
        listOf(
            "\"21:mixed\": 1", "\"21:requested\": 1", "\"21:remaining\": 92",
            "\"35:all\": 94", "\"36:account-dashboard\": 29",
            "\"36:first-run-setup\": 19", "\"36:status-routes\": 46",
