...
class LoginLifecycleContractTest {
    ...
    fun accountRecreationRuntimeJobUsesTheRequiredUnsignedMatrixAndPinnedRunner() {
        ...
        listOf(
            "app:connectedDebugAndroidTest", "focused-runtime-ledger-v1.json", "len(tests) != 87",
    ...
    fun freshEmulatorShardsAreBoundedDisjointAndExactlyCoverRuntimeMethods() {
        ...
        assertTrue(runtimeScript.contains("if len(tests) != 87 or len(set(tests)) != 87"))
        listOf(
            "\"21:mixed\": 1", "\"21:requested\": 1", "\"21:remaining\": 85",
            "\"35:all\": 87", "\"36:account-dashboard\": 27",
            "\"36:first-run-setup\": 18", "\"36:status-routes\": 42",
