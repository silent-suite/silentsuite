...
constructor(internal val context: Context, internal val account: Account) {
    ...
    class AppUpdatedReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            Logger.log.info("SilentSuite was updated, checking for AccountSettings version")
    ...
    companion object {
        ...
        /* Whether SilentSuite sets the local calendar color to the value from service DB at every sync
