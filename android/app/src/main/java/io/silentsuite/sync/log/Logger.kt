    ...
    private fun reinitialize() {
        ...
        if (logToFile) {
            ...
            builder.setSmallIcon(R.drawable.ic_sd_storage_light)
                    ...
                    .setContentTitle(context.getString(R.string.logging_file_logging))

            val logDir = debugDir(context) ?: return
            val logFile = File(logDir,
                    "silentsuite-${Process.myPid()}-${DateFormatUtils.format(System.currentTimeMillis(), "yyyyMMdd-HHmmss")}.txt")
