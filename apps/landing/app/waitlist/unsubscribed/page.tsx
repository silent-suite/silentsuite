...
export const metadata: Metadata = {
  title: 'Unsubscribed | SilentSuite',
  description: 'You have been unsubscribed from SilentSuite updates.',
}
      ...
      <div className="max-w-lg mx-auto px-6 text-center">
        <div className="p-10 rounded-2xl bg-teal-400/10 border border-teal-400/30">
          ...
          <p className="text-navy-300 mb-6">
            You will no longer receive emails from SilentSuite. If this was
            a mistake, you can subscribe again on our homepage.
          </p>
          <Link
            href="/"
